...
def plot_1():
    ...
    speed_up__l = [float(.211)/float(.194),
            float(.211)/float(.195),
            float(.211)/float(.196),
            float(.211)/float(.202)]
...
#        print str(el) + " " + str(max_temperature__switching_temp_speed_up__curve[el])
    ...
    # *** F:DN draw graph 
    counter = 0
    fig, axarr  = start_up_making_graph_2(1)
    ...
    for temp__el in max_temp_key_list:
        ...
        generate_graph_2d_for_one_set_of_input(axarr[0], fig, data_x,
                data_y,"Speedup",
                "Mode-switch Temperature"+"($^\circ$C)", str(temp__el), 1, counter,
                n_colors, False)
        counter +=1
    ...
    """ 
    src__f__addr__l =\
            ["/home/local/pow/behzad/verilog_files/apx_operators/int_ops_apx/src/v_src/optimals__found_so_far/idct/component_level/delay_profile/diff_delays/optimal__1/2017_09_01__02_20_58/mul_26__clk_0.68__acc_max_del_0__Pn_18__atmpt_-1__id_DFDL__1__evol_log.txt",
             "/home/local/pow/behzad/verilog_files/apx_operators/int_ops_apx/src/v_src/optimals__found_so_far/idct/component_level/delay_profile/diff_delays/optimal__2/2017_09_01__02_20_49/mul_26__clk_0.68__acc_max_del_0__Pn_18__atmpt_-1__id_DFDL__2__evol_log.txt",
"/home/local/pow/behzad/verilog_files/apx_operators/int_ops_apx/src/v_src/optimals__found_so_far/idct/component_level/delay_profile/diff_delays/optimal__3/2017_09_01__02_20_40/mul_26__clk_0.68__acc_max_del_0__Pn_18__atmpt_-1__id_DFDL__3__evol_log.txt",
"/home/local/pow/behzad/verilog_files/apx_operators/int_ops_apx/src/v_src/optimals__found_so_far/idct/component_level/delay_profile/diff_delays/optimal__4/2017_09_01__02_20_32/mul_26__clk_0.68__acc_max_del_0__Pn_18__atmpt_-1__id_DFDL__4__evol_log.txt",
"/home/local/pow/behzad/verilog_files/apx_operators/int_ops_apx/src/v_src/optimals__found_so_far/idct/component_level/delay_profile/diff_delays/optimal__5/2017_09_01__02_21_25/mul_26__clk_0.68__acc_max_del_0__Pn_18__atmpt_-1__id_DFDL__5__evol_log.txt"]
#
    """
    ...
    #
    speed_up__l =\
    [float(.737)/float(.707),  # *** F:DN for multiplier
            float(.737)/float(.7075),
            #float(.743)/float(.709), 
            #float(.743)/float(.713),
            float(.737)/float(.714),
            float(.737)/float(.72)]
...
#        print str(el) + " " + str(max_temperature__switching_temp_speed_up__curve[el])
    ...
    for temp__el in max_temp_key_list:
        ...
        data_x = map(lambda x: x[0], switching_temp_speed_up)
        data_y = map(lambda x: x[1], switching_temp_speed_up)
        generate_graph_2d_for_one_set_of_input(axarr[1], fig, data_x,
                data_y,"Speedup",
                "Mode-switch Temperature"+"($^\circ$C)", str(temp__el), 1, counter,
                n_colors)
        counter +=1
    ...
    finish_up_making_graph_2(axarr, " ",\
