...
# Created by write_sdc on Sat Sep  2 19:00:35 2017
...
create_clock [get_ports clk]  -period 0.538  -waveform {0 0.269}
...
set_input_delay -clock clk  -max 0  [get_ports acc__sel]
