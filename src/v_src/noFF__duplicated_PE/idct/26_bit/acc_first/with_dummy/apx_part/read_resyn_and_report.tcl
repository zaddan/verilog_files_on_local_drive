...
#---acc first
report_timing -sort_by group -nworst 1000 -significant_digits 4  -through [get_object_name [get_pins -of_objects [get_object_name [get_cells -hierarchical -filter "full_name == mul__inst__apx"]]  -filter "direction == in"]] >  ${REPORTS_DIR}/${report_file__prefix}__timing.rpt
