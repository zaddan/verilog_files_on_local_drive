...
set RTLDIR ~/behzad_local/verilog_files/fpu_dawsongon/multiplier
...
for { set NAB 0}  {$NAB < 1} {incr NAB 1} {
    analyze -format verilog [list multiplier.v]
    elaborate $my_toplevel -update
    saif_map -start 
    link
    create_clock -name clk -period 1.5 -waveform {0 .75} [get_ports clk]
    ...
    read_saif -auto_map_names -input ~/behzad_local/verilog_files/apx_operators/float_ops_apx/DUT.saif -instance test_bench_tb/multiplier_39759952_acc -verbose 

    report_timing -sort_by slack -input_pins -capacitance -transition_time -nets -significant_digits 4 -nosplit -nworst 1 -max_paths 1 > ${REPORTS_DIR}/float_${DESIGN_NAME}_${NAB}_timing.rpt
    report_area -hierarchy -nosplit > ${REPORTS_DIR}/float_${DESIGN_NAME}_${NAB}_area.rpt
    report_power -analysis_effort high
    report_power > ${REPORTS_DIR}/float_${DESIGN_NAME}_${NAB}_power.rpt
