...
set DESIGN_NAME unconfig_int_add_OP_BITWIDTH32_DATA_PATH_BITWIDTH32 
...
set saif_file_addr ${DESIGN_NAME}.saif
...
read_saif ${sim-res_dir}/${saif_file_addr} -strip_path test_bench_tb/add 

#report_switching_activity -list_not_annotated 
#pt_shell> report_power -verbose -hierarchy
report_power -verbose -hierarchy > ${REPORTS_DIR}/${DESIGN_NAME}_${OP_BITWIDTH}Bit_${DATA_PATH_BITWIDTH}Bit_power_with_saif.rpt
