...
set msb_3_min_delay 0;#.43;#.43;#0 
set msb_4_min_delay 0;#0;#.42 ;#.242 ideally
...
set msb_1_reg_d_l [make-reg_l "d" [expr 2 * $lsb_bits] $DATA_PATH_WIDTH]
...
set msb_2_reg_d_l [make-reg_l "d" [expr 2 * [expr $lsb_bits + 4]] $DATA_PATH_WIDTH]
...
set msb_4_reg_d_l [make-reg_l "d" [expr 2 * [expr $lsb_bits + 12]] $DATA_PATH_WIDTH]
...
#        set_min_delay $msb_4_min_delay -from $msb_4_reg_a_b_c_joined -to $msb_4_reg_d_l
#   }
}
