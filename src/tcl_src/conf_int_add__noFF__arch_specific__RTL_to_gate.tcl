...
#set_dont_touch_network [get_ports a*]
#set_dont_touch_network [get_ports b*]
...
set compile_ultra_ungroup_dw false; #*** F:TN this is to prevent ungrouping
set compile_ultra_ungroup_small_hierarchies false; #*** F:TN prevent gettign rid of 
                                                   #         small hierarchies

#set_dp_smartgen_options -all_options false 
#set_dp_smartgen_options  -carry_select_adder_cell true ; #*** F:TN this is supposed
#                                                         # to use csa for implementation
#                                                         # but it's not
